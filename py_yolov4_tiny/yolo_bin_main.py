...
from quantize_analysis.debug_main import load_bin
...
out0,out1=my_yolo_tst.forward(In)
...
out0_cpp_tst= load_bin(hw_dir,"yolo_out0_q8",(1,75,13,13),np.int8)
out1_cpp_tst= load_bin(hw_dir,"yolo_out1_q8",(1,75,26,26),np.int8)


out0=out0_cpp_tst.astype(float)*yoloheadp5_S_a
out1=out1_cpp_tst.astype(float)*yoloheadp4_S_a
...
image.save('output/street.jpg', 'JPEG', quality=95)
image.show()
