...
void conv_2d::forward(data_t *x ,int32_t *out)
{
    ...
    std::cout << "conv_start_time:"<< time_start <<std::endl;
    ...
    std::cout << "conv_finish_time:"<< time_finish <<std::endl;
    std::cout << "conv_latency:"<< (time_finish-time_start) <<std::endl;
}
...
void leakyrelu::forward(data_t *x,int32_t *out)
{
    ...
    unsigned int time_finish=0;
    time_start = count_timer;
    std::cout << "leakyrelu_start_time:"<< time_start <<std::endl;
	//Row:
    ...
    time_finish = count_timer;
    std::cout << "leakyrelu_finish_time:"<< time_finish <<std::endl;
    std::cout << "leakyrelu_latency:"<< (time_finish-time_start) <<std::endl;
}
...
void maxpooling::forward(data_t *x,data_t *out)
{
    ...
    unsigned int time_finish=0;
    time_start = count_timer;
    std::cout << "maxpooling_start_time:"<< time_start <<std::endl;
	//Row:
	for(int r=0;r<out_shape[1];r++)
	{
		//Column:
    ...
    time_finish = count_timer;
    std::cout << "maxpooling_finish_time:"<< time_finish <<std::endl;
    std::cout << "maxpooling_latency:"<< (time_finish-time_start) <<std::endl;
}
...
void csp_dark_net::forward(data_t *x,data_t *out0,data_t *out1)
{
    ...
    delete [] Out1;
    //resblock_body1
    std::cout <<"resblock_body1" <<std::endl;
    int8_t *out0_res1;
    int8_t *out1_res1;
    ...
    delete [] out1_res1;
    //resblock_body2
    std::cout <<"resblock_body2" <<std::endl;
    int8_t *out0_res2;
    int8_t *out1_res2;
    ...
    delete [] out1_res2;
    //resblock_body3
    std::cout <<"resblock_body3" <<std::endl;
    int8_t *out0_res3;
...
void upsampling::forward(data_t *x,data_t *out)
{
    ...
    unsigned int time_finish=0;
    time_start = count_timer;
    std::cout << "upsampling_start_time:"<< time_start <<std::endl;
    //Row:
	for(int r=0;r<in_shape[1];r++)
	{
		//Column:
    ...
    time_finish = count_timer;
    std::cout << "upsampling_finish_time:"<< time_finish <<std::endl;
    std::cout << "upsampling_latency:"<< (time_finish-time_start) <<std::endl;
}
