...
#include "/home/derui/work/C_proj/yolo_v4_tiny_baseline/whole_tst/base_layer.h"
...
void yolo_head::forward(data_t *x,data_t *out)
{
    ...
    load_int16_data(m0 , data_dir+"/conv2/" +"m_0.bin" , 2);
    load_int32_data(conv2.bias ,  data_dir+"/conv2/" +"b_q.bin" , streamsize (4*conv2.output_channels)); 
